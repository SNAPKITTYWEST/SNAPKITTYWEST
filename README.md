...
| Entropy E | **0.5644** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `930c5222785bba22ed361cc171f9ce3d206885e0760b2090a5fe0065b601c5d2` |
| Last field read | `2026-09-24T21:12:58.654Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.5644 → FAIL
