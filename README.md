...
| Entropy E | **0.5549** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `43e10da8bc2a290719c06a518deac9b8281afd59b14d007d2c1657234c3f2c9a` |
| Last field read | `2026-08-12T19:02:04.368Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.5549 → FAIL
