...
| Entropy E | **0.4394** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `a00378c72d5c3cbae44beaf7ed03213f377134fe41f6bc758760d8b2ca6c08a5` |
| Last field read | `2026-09-18T15:56:41.005Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4394 → FAIL
