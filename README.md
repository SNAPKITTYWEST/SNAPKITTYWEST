...
| Entropy E | **0.5257** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `4996027b4c27b0f964213bd1af033c7a8d0aa0b4f7c0fb66bdff1ec9edaa0c7b` |
| Last field read | `2026-09-22T03:38:24.832Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.5257 → FAIL
