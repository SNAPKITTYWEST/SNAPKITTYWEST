...
| Entropy E | **0.4680** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `ec3ea58b85b03b436c9e1773d2083d41d4aea9a24c88f59266cae7873c52dc23` |
| Last field read | `2026-08-22T12:38:21.641Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4680 → FAIL
