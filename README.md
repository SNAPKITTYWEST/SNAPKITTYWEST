...
| Entropy E | **0.4378** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `d8f702bd396fb5114a613e7f359ab533e50d61912479aebda7a2d9b5bd73d2f5` |
| Last field read | `2026-08-30T11:23:17.771Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4378 → FAIL
