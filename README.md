...
| Metric | Value |
|--------|-------|
| Constellation | SNAPKITTYWEST (194) · SNAPKITTY-COLLECTIVE-LIMITED-FLP (7) · AHMADALIPARR (6) · SNAPKITTYAGENT9NOVA (9) |
| Total repos | **216** |
| Active (< 30d) | **118** |
| GitHub Pages live | **49** |
| Entropy E | **0.4537** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `48f03259f830d3f505a179142ab49e5e5a9ec8f7f59c028c0d5d2521a9286659` |
| Last field read | `2026-08-25T12:47:02.682Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4537 → FAIL
