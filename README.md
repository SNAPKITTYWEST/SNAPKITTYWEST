...
| Metric | Value |
|--------|-------|
| Constellation | SNAPKITTYWEST (98) · SNAPKITTY-COLLECTIVE-LIMITED-FLP (6) · AHMADALIPARR (6) · SNAPKITTYAGENT9NOVA (4) |
| Total repos | **114** |
| Active (< 30d) | **103** |
| GitHub Pages live | **37** |
| Entropy E | **0.0965** / threshold 0.21 |
| Coherent | **YES** |
...
| Ω WORM Seal | `5b314753fc39a86e5c1ecc396bc721205648f0eaf04b31226af73951db9208bf` |
| Last field read | `2026-07-11T00:09:32.668Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.0965 → PASS
