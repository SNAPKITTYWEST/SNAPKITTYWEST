...
| Metric | Value |
|--------|-------|
| Constellation | SNAPKITTYWEST (270) · SNAPKITTY-COLLECTIVE-LIMITED-FLP (7) · AHMADALIPARR (6) · SNAPKITTYAGENT9NOVA (21) |
| Total repos | **304** |
| Active (< 30d) | **170** |
| GitHub Pages live | **62** |
| Entropy E | **0.4408** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `501849fe063856b9cafa69fb8f0b44885f17abe20a273e58603374ee0fe35b58` |
| Last field read | `2026-09-10T10:46:10.708Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4408 → FAIL
