...
| Entropy E | **0.1196** / threshold 0.21 |
| Coherent | **YES** |
...
| Ω WORM Seal | `373272f949771813bcf62779a33f7955fd04ca17e55b1455463026eb63a818cb` |
| Last field read | `2026-07-04T20:11:14.745Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.1196 → PASS
