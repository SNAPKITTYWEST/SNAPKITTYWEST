...
| Entropy E | **0.5464** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `676a86769ed1472bd15ec787a564232b46eebbb27f87deadd11cfb98023ec3e4` |
| Last field read | `2026-09-23T21:10:28.990Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.5464 → FAIL
