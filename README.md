...
| Entropy E | **0.4813** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `84b7b2e06459717906b535c08c17f9cf425a7a826bf145573292df196df40e38` |
| Last field read | `2026-08-06T23:59:25.649Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4813 → FAIL
