...
| Entropy E | **0.4366** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `f3d88190ca9ffc9288d8f13d7c120fa1de923781228dfec05460b5daeb5003c2` |
| Last field read | `2026-09-18T10:41:08.807Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4366 → FAIL
