...
| Metric | Value |
|--------|-------|
| Constellation | SNAPKITTYWEST (155) · SNAPKITTY-COLLECTIVE-LIMITED-FLP (7) · AHMADALIPARR (6) · SNAPKITTYAGENT9NOVA (5) |
| Total repos | **173** |
| Active (< 30d) | **76** |
| GitHub Pages live | **47** |
| Entropy E | **0.5607** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `276051d28989593ba1cfac400f916a25cd58a8520276e6cf517d999cfd5c505d` |
| Last field read | `2026-08-13T07:26:51.053Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.5607 → FAIL
