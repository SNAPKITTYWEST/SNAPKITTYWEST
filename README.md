...
| Entropy E | **0.1563** / threshold 0.21 |
| Coherent | **YES** |
...
| Ω WORM Seal | `87d7e7eadad9dedbbe208476b5efd293a4eef1887a813c23bc1a73232067d88c` |
| Last field read | `2026-06-27T03:31:10.687Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.1563 → PASS
