...
| Total repos | **151** |
| Active (< 30d) | **125** |
| GitHub Pages live | **44** |
| Entropy E | **0.1722** / threshold 0.21 |
| Coherent | **YES** |
...
| Ω WORM Seal | `975679279427667f7eafec97543a232170bf1f16f9ed577d2ee3103c99a8f151` |
| Last field read | `2026-07-31T08:49:36.421Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.1722 → PASS
