...
| Entropy E | **0.5614** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `b46af477ca599d0e29e88a93a71c76e988e520b2b2cb8a7bc6b0d227a9b4ccf7` |
| Last field read | `2026-08-11T13:05:05.638Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.5614 → FAIL
