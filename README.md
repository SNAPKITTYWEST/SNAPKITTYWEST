...
| Metric | Value |
|--------|-------|
| Constellation | SNAPKITTYWEST (235) · SNAPKITTY-COLLECTIVE-LIMITED-FLP (7) · AHMADALIPARR (6) · SNAPKITTYAGENT9NOVA (9) |
| Total repos | **257** |
| Active (< 30d) | **141** |
| GitHub Pages live | **55** |
| Entropy E | **0.4514** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `f4e1810f0635df825dbb12da27521b2f2244752d25628411337ea78d184a9e57` |
| Last field read | `2026-09-02T16:04:41.717Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4514 → FAIL
