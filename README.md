...
| Entropy E | **0.4654** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `e73b522f5c1e20b16aa1433501a040d79ebcfa1c1e83b168e8c11b8e7ba931bb` |
| Last field read | `2026-08-04T02:32:30.020Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4654 → FAIL
