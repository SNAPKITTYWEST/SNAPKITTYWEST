...
| Entropy E | **0.5380** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `b68ebb0cbfa7397bb976dec63dd0c88fa0c87c2a877366bad927a0e35d489b97` |
| Last field read | `2026-08-10T13:07:34.849Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.5380 → FAIL
