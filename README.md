...
| Entropy E | **0.5497** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `1c33d726651670c60a3e35276a7bb1b94664de6c3da1355fca9687abd9bcd8fe` |
| Last field read | `2026-08-11T07:07:14.767Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.5497 → FAIL
