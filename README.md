...
| Total repos | **272** |
| Active (< 30d) | **155** |
| GitHub Pages live | **60** |
| Entropy E | **0.4301** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `2a04f5d1d2ee3555129f8c7eb85cee49592b1cfb0f12a6b800ea6b15941dd915` |
| Last field read | `2026-09-06T10:23:19.450Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4301 → FAIL
