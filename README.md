...
| Entropy E | **0.1987** / threshold 0.21 |
| Coherent | **YES** |
...
| Ω WORM Seal | `bef2a62c33083dd403b3ceae700ee3e8d91318df72072017f77f600fd00b94e1` |
| Last field read | `2026-07-31T14:06:53.731Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.1987 → PASS
