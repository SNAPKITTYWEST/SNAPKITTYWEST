...
| Entropy E | **0.4619** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `476bdd0e13385a05b1f560ca58a6eb9242a04a5a13796fb3e8522dcc203e82d7` |
| Last field read | `2026-08-24T01:17:17.864Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4619 → FAIL
