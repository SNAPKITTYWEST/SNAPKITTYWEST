...
| Entropy E | **0.2166** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `5502791a17844a31069e32067db733fef11eba0902e64e6e167cbfc799009fda` |
| Last field read | `2026-08-01T19:07:50.807Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.2166 → FAIL
