...
| Metric | Value |
|--------|-------|
| Constellation | SNAPKITTYWEST (142) · SNAPKITTY-COLLECTIVE-LIMITED-FLP (7) · AHMADALIPARR (6) · SNAPKITTYAGENT9NOVA (5) |
| Total repos | **160** |
| Active (< 30d) | **84** |
| GitHub Pages live | **48** |
| Entropy E | **0.4750** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `2d5d11f36c7b0936575425fddcec0c13d0cd9016bc9f7bcafd5c9f49c23c3ef8` |
| Last field read | `2026-08-05T08:35:51.611Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.4750 → FAIL
