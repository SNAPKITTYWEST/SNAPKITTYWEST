...
| Entropy E | **0.2704** / threshold 0.21 |
| Coherent | **NO** |
...
| Ω WORM Seal | `062e7cb8d9689a6c1d1f01043086685785e8bba1e18a29e97dbd7a8f5c632a01` |
| Last field read | `2026-08-03T09:45:37.779Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.2704 → FAIL
