...
| Entropy E | **0.0822** / threshold 0.21 |
| Coherent | **YES** |
...
| Ω WORM Seal | `35603dc5c88e59a198c4fe79d68af15789cf8d30120dad4edee7f857bf88c491` |
| Last field read | `2026-07-26T19:10:49.670Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.0822 → PASS
